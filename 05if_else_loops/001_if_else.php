...
if($timeToLearn == true) {
    echo "Я как раз сейчас учусь.";
} else {
    echo "Что значит ещё не время? Нет, для учебы всегда есть время. ";
};
